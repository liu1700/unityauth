...
// checks if the PlayerAuthNotFoundErrorV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlayerAuthNotFoundErrorV1{}

// PlayerAuthNotFoundErrorV1 struct for PlayerAuthNotFoundErrorV1
type PlayerAuthNotFoundErrorV1 struct {
...
func NewPlayerAuthNotFoundErrorV1() *PlayerAuthNotFoundErrorV1 {
	this := PlayerAuthNotFoundErrorV1{}
	return &this
}
...
func (o PlayerAuthNotFoundErrorV1) MarshalJSON() ([]byte, error) {
...
func (o PlayerAuthNotFoundErrorV1) ToMap() (map[string]interface{}, error) {
...
type NullablePlayerAuthNotFoundErrorV1 struct {
	value *PlayerAuthNotFoundErrorV1
	isSet bool
}

func (v NullablePlayerAuthNotFoundErrorV1) Get() *PlayerAuthNotFoundErrorV1 {
	return v.value
}

func (v *NullablePlayerAuthNotFoundErrorV1) Set(val *PlayerAuthNotFoundErrorV1) {
	v.value = val
	v.isSet = true
}

func (v NullablePlayerAuthNotFoundErrorV1) IsSet() bool {
	return v.isSet
}

func (v *NullablePlayerAuthNotFoundErrorV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlayerAuthNotFoundErrorV1(val *PlayerAuthNotFoundErrorV1) *NullablePlayerAuthNotFoundErrorV1 {
	return &NullablePlayerAuthNotFoundErrorV1{value: val, isSet: true}
}

func (v NullablePlayerAuthNotFoundErrorV1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlayerAuthNotFoundErrorV1) UnmarshalJSON(src []byte) error {
	v.isSet = true
