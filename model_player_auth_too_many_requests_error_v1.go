...
// checks if the PlayerAuthTooManyRequestsErrorV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlayerAuthTooManyRequestsErrorV1{}

// PlayerAuthTooManyRequestsErrorV1 struct for PlayerAuthTooManyRequestsErrorV1
type PlayerAuthTooManyRequestsErrorV1 struct {
...
func NewPlayerAuthTooManyRequestsErrorV1() *PlayerAuthTooManyRequestsErrorV1 {
	this := PlayerAuthTooManyRequestsErrorV1{}
	return &this
}
...
func (o PlayerAuthTooManyRequestsErrorV1) MarshalJSON() ([]byte, error) {
...
func (o PlayerAuthTooManyRequestsErrorV1) ToMap() (map[string]interface{}, error) {
...
type NullablePlayerAuthTooManyRequestsErrorV1 struct {
	value *PlayerAuthTooManyRequestsErrorV1
	isSet bool
}

func (v NullablePlayerAuthTooManyRequestsErrorV1) Get() *PlayerAuthTooManyRequestsErrorV1 {
	return v.value
}

func (v *NullablePlayerAuthTooManyRequestsErrorV1) Set(val *PlayerAuthTooManyRequestsErrorV1) {
	v.value = val
	v.isSet = true
}

func (v NullablePlayerAuthTooManyRequestsErrorV1) IsSet() bool {
	return v.isSet
}

func (v *NullablePlayerAuthTooManyRequestsErrorV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlayerAuthTooManyRequestsErrorV1(val *PlayerAuthTooManyRequestsErrorV1) *NullablePlayerAuthTooManyRequestsErrorV1 {
	return &NullablePlayerAuthTooManyRequestsErrorV1{value: val, isSet: true}
}

func (v NullablePlayerAuthTooManyRequestsErrorV1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlayerAuthTooManyRequestsErrorV1) UnmarshalJSON(src []byte) error {
	v.isSet = true
